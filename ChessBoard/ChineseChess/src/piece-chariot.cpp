...
PieceChariot::PieceChariot(ChessPlayer player) : Piece(CC_PIECE_CHARIOT, "R", "Chariot", player)
{
	
}

PieceChariot::~PieceChariot()
{
	
}

bool PieceChariot::validateStep(PieceDirection direction, int steps)
{
